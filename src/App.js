...
class App extends Component {
  ...
  load(class_name) {
    ...
    if (this.state.auto_seats) {
      ...
      newState.seats_per_row = Math.max(
        Math.ceil(students.length / 4),
        this.state.min_seats_per_row
      );
    }
  ...
  moveStudent(movingStudent, targetStudent, to, from) {
    ...
    this.setState(
      { list: students.map((s) => s.join(";")).join("\n") },
      this.layout
    );
  }
  ...
  render() {
    ...
    const studentGridStyles = {
      gridTemplateColumns: `repeat(${
        ((this.state.with_gutter ? 4 : 0) + numSeats) / 4
      },1fr)`,
    };
    ...
    return (
      <div className="App">
              ...
              <div className="col-sm-4">
                ...
                <ul>
                  {saved_classes.map((k, v) => {
                    return (
                      <li key={k}>
                        <a onClick={() => this.load(k)}>{k}</a>{" "}
                        <a
                          onClick={() => this.deleteClass(k)}
                          style={{ color: "darkred" }}
                        >
                          [X]
                        </a>
              ...
              >
                <div>
                  <textarea
                    ...
                    onChange={(e) =>
                      this.setState({ list: e.target.value }, this.layout)
                    }
                  ></textarea>
                </div>
                <div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="col-xs-10">
                      <input
                        ...
                        onChange={(e) =>
                          this.save("class_name", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="col-xs-10">
                      <input
                        ...
                        onChange={(e) => this.save("date_time", e.target.value)}
                      />
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="col-xs-10">
                      ...
                      >
                        <input
                          type="checkbox"
                          id="swap_students"
                          checked={this.state.swap_students}
                          onChange={() => this.toggle("swap_students")}
                        />
                      </Tipsy>
                    </div>
                  </div>
                    ...
                    <div className="col-xs-10">
                      ...
                      >
                        <input
                          type="checkbox"
                          id="swap_students"
                          checked={this.state.color_print}
                          onChange={() => this.toggle("color_print")}
                        />
                      </Tipsy>
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="col-xs-10">
                      <input
                        ...
                        value={this.state.seats_per_row}
                        onChange={(e) =>
                          this.save("seats_per_row", e.target.value)
                        }
                      />
                    </div>
                  </div>
                    ...
                    <div className="col-xs-10">
                      ...
                      >
                        <input
                          type="checkbox"
                          id="auto_seats"
                          checked={this.state.auto_seats}
                          onChange={() => this.toggle("auto_seats")}
                        />
                      </Tipsy>
                    </div>
                  </div>
                    ...
                    <div className="col-xs-10">
                      ...
                      >
                        <input
                          type="checkbox"
                          id="with_gutter"
                          checked={this.state.with_gutter}
                          onChange={() => this.toggle("with_gutter")}
                        />
                      </Tipsy>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <input
                        type="checkbox"
                        id="boy_girl"
                        checked={this.state.boy_girl}
                        onChange={() => this.toggle("boy_girl")}
                      />
                    </label>
        ...
        <div className="headerGrid">
          <div>
            Class:{" "}
            <span style={{ fontSize: "70%" }}>{this.state.class_name}</span>
          </div>
          <div>
            Time/Days:{" "}
